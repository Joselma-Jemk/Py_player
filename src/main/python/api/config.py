"""Configuration centralisée de PyPlayer."""
...
class PyPlayerConfig:
    """Porte toute la configuration runtime et projet de PyPlayer."""
    ...
    def _find_project_root(self, start_path: Path) -> Path:
        ...
        raise FileNotFoundError(
            ...
            "Marqueurs attendus: requirements.txt (et idéalement README.md)."
        )
    ...
    def load_preferences(self) -> dict[str, str | int]:
        ...
        try:
            ...
            self.logger.warning("preferences.json invalide (%s), fallback par défaut.", error)
            return self.default_preferences.copy()
