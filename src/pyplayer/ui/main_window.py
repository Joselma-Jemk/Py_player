...
from src.pyplayer.domain.media import VIDEO_EXTENSIONS, Video
...
from src.pyplayer.ui.widgets import (
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def customize_self(self):
        self.setWindowIcon(QtGui.QIcon(get_icon_directory()))
        self.setWindowTitle("PyPlayer")
        self.resize(1000, 600)
        self.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.NoContextMenu)
        self.setProperty("theme", "néon")
        self.setStyleSheet(f"background: {SECONDARY_COLOR};")
